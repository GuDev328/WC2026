...
function buildBracket(ko: Record<string, Match[]>) {
  ...
  add('L-R16-1', 20 + COL_W, ry(0, 6), 'R16', r16(2))
  add('L-R16-2', 20 + COL_W, ry(3, 6), 'R16', r16(1))
  ...
  add('L-R16-5', 20 + COL_W, ry(botY, 6), 'R16', r16(6))
  add('L-R16-6', 20 + COL_W, ry(botY + 3, 6), 'R16', r16(5))
  ...
  add('R-R16-7', rCol0 + 2 * COL_W, ry(botY, 6), 'R16', r16(8))
  add('R-R16-8', rCol0 + 2 * COL_W, ry(botY + 3, 6), 'R16', r16(7))
